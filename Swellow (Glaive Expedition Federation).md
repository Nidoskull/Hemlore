...
Swellow speaks at minimum [Satojiran](Satojiri).

## Relationships
Swellow has no known relatives, but *is* partnered to [Latias](Latias).

Swellow used to have an unknown teammate. It is unknown what happened to them.

## History
Unfortunately, I recall very little about Swellow's past. At some point he evolved from Taillow into Swellow, and that's everything I can remember right now.

#### Tags:
#character #npc #explorer #glaiveexpeditionfederation 