...
## Description
**Neon** the [Shiny](Mech.Shiny) **[Eelektrik](Species.Tynamo)** is a rookie adventurer that's part of [Team Nova](Team.Nova). Washed ashore near [Dura Town](Dura%20Town), it is 16 years old and was born in the ocean in an unknown location. They have also been known as Ty ~~and Tynamite~~ before he chose its name. She uses they/it/he/she pronouns.

Neon is *incredibly* [Hasty](Mech.Nature) and as lucky as being a shiny would be. Due to evolving early to special circumstances, He's a different color than regular Eelektrik, or a Shiny Eelektrik for that matter; Neon is a green incredibly similar to [Zygarde](Tale.Zygarde)'s coloration. Its usually-yellow belly and fins are closer to Tynamo's blue-ish white, and her lips and tail fin are similarly colored like Tynamo's mouth.

Neon speaks [Satojiran](Region.Satojiri) and at least one Water-type language that doesn't have a name in Satojiran ~~yet~~.

## Relationships
Neon has no known relatives due to the whole The Ocean and The Currents thing. 

As founding member of Team Nova, Neon is close to [Hemlock of Belladonna](Char.Hemlock%20of%20Belladonna), [Gambit the Pawniard](Char.Gambit%20the%20Pawniard), [Aemilia the Rookidee](Char.Aemilia%20the%20Rookidee) and [Sheo the Gastly](Char.Sheo%20the%20Gastly).
...
Additionally, as a shiny she has a psychic link with [Victini](Tale.Victini). Neon also got close with [Zygarde](Tale.Zygarde) during various missions, and was saved by [Latias](Tale.Latias) one time before joining the guild.
...
During its travel, they encountered Zygarde's flames during a time of need, when some form of icky film threatened to drown him. Zygarde burnt away the sludge, saving Neon in the process.

Finding its way to [Dura Town](City.Dura%20Town), Neon manages to join the guild into Team Nova.
...
#### Tags:
#character #pc #glaiveexpeditionfederation #explorer #teamnova #tynamo #eelektrik #shiny
