...
The **Glaive Expedition Federation** is a [Guild](Mech.Guild) based in [Dura Town](City.Dura%20Town). Founded by [Guildmaster Baxcalibur](Char.Guildmaster%20Baxcalibur), it was originally located on [Guranbar Island](Loc.Guranbar%20Island) in [Kareblye](Region.Kareblye). It is sometimes shortened to simply "the Glaive guild".
...
- [Librarian Relicanth](Char.Relicanth%20(Glaive)) 
- [Machoke](Char.Machoke%20(Glaive)) 
- [Ursaring](Char.Ursaring%20(Glaive)) 
- [Litleo](Char.Litleo%20(Glaive)) ([Litleo's Team](Team.Litleo)) 
- [Steenee](Char.Steenee%20(Glaive)) ([Farigiraf's Team](Team.Farigiraf)) 
- [Drizzile](Char.Drizzile%20(Glaive)) ([Drizzile's Team](Team.Drizzile)) 
...
- [Mars the Larvitar](Char.Mars%20the%20Larvitar) 
...
- [Bronze the Beldum](Char.Bronze%20the%20Beldum) (Team Gummy)
...
- [Jazz the Runerigus](Char.Jazz%20the%20Runerigus) (Team Orchard)


### Former Members
- [Tepig](Char.Tepig%20(Glaive))† (Drizzile's Team)
- [Bulbasaur](Char.Bulbasaur%20(Glaive))† (Drizzile's Team)
- [Samui](Char.Samui%20the%20Frigibax)†
- [Tyrunt](Char.Tyrunt%20(Glaive)) (Litleo's Team)
- [Farigiraf](Char.Farigiraf%20(Glaive)) (Farigiraf's Team)

## History

Originally based on [Guranbar Island](Loc.Guranbar%20Island), the Guild encountered a setback when a [Flame Wing](Tale.Moltres) cultist attempted to revive his deity. Fortunately, only one mon was fatally wounded; the same cultist that spurred the event.
...
[Team Orchard](Team.Orchard) finds the tomb of the [Sailor King](Char.Sailor%20King).

[Team Stamp Squad](Team.StampSquad) finds a [Tera Seed](Mech.Tera%20Crystal) and plants it in Dura Town. Shortly after, Terastalized Pokémon appear in the Mystery Dungeons near Dura Town!

Team Orchard recruits [Ostana the Hattrem](Char.Ostana%20(Ostana%27s%20Opus)) as an Alchemist for Dura Town.

Team Stamp Squad obtains a [Cryptographic Key](Item.Cryptographic%20Key) for the Guild from Mount Maw.

[Team Nova](Team.Nova) of the Guild corrects the timeline and returns [Carew City](City.Carew%20City) into existence.

Team Nova also finds one of the reliquaries holding a piece of the [Queen of Shattered Crystal](Char.Queen%20of%20Shattered%20Crystal)'s corpse.

The Guild begins a construction project for a [Freezerift Core](Item.Freezerift%20Core) for [Dura Town](City.Dura%20Town).
#### Tags

#guild #satojiri #glaiveexpeditionfederation #landing #category
